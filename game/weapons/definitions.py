...
WEAPON_DEFS: dict[str, WeaponDef] = {
    ...
    "AK74u":   WeaponDef("AK74u",   bullet_speed=28, bullet_spread=4,  fire_rate=12,   damage=2,  penetration=2, magazine_size=30,  reload_time=2.4, reserve_max=180, shoot_sound="smg_shot.wav"),
    "Galil":   WeaponDef("Galil",   bullet_speed=30, bullet_spread=3,  fire_rate=10,   damage=3,  penetration=3, magazine_size=35,  reload_time=3.0, reserve_max=210, shoot_sound="smg_shot.wav"),
    "SMG":     WeaponDef("SMG",     bullet_speed=24, bullet_spread=6,  fire_rate=18,   damage=1,  penetration=1, magazine_size=40,  reload_time=2.0, reserve_max=240, shoot_sound="smg_shot.wav"),
    "LMG":     WeaponDef("LMG",     bullet_speed=27, bullet_spread=5,  fire_rate=10,   damage=4,  penetration=4, magazine_size=100, reload_time=5.5, reserve_max=400, shoot_sound="smg_shot.wav"),
    "Sniper":  WeaponDef("Sniper",  bullet_speed=40, bullet_spread=0,  fire_rate=1.2,  damage=20, penetration=6, magazine_size=5,   reload_time=3.5, reserve_max=30,  shoot_sound="shotgun_sound.mp3"),
